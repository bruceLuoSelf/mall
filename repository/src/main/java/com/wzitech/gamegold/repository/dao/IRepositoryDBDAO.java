...
public interface IRepositoryDBDAO extends IMyBatisBaseDAO<RepositoryInfo, Long>{
    ...
    /**
     * 查询营业的店铺的库存列表信息 仅限地下城与勇士 商品为游戏币
     * @param queryParam
     * @return
     */
    ...
    /**
     * 查询店铺列表 仅地下城与勇士除金币之外的情况 及其他游戏
     * @param queryMap
     * @return
     */
    List<RepositoryInfo> queryUniqueAndOldSellerRepository(Map<String,Object> queryMap);

    /**
     * 营业的店铺的库存列表总数  仅查询地下城勇士(游戏币)
     * @param queryParam
     * @return
     */
     ...
     * @return
     */
    int countUniqueAndOldSellerRepository(Map<String,Object> queryParm);
    /**
     * 前台最低价格列表
     * @param queryParam
     * @param start
    ...
    GenericPage<RepositoryInfo> selectSalableRepositoryForPage(Map<String, Object> queryParam, int pageSize, int startIndex, String orderBy, boolean isAsc);
}
