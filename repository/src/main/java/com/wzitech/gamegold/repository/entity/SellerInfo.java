 ...
 *	创建时间：	2014-2-22
 *	描	述：		
 *	更新纪录：	1. HeJian 创建于 2014-2-22 下午9:15:17
 * 				
 ************************************************************************************/
...
//	
	...
	public void setIsCross(Boolean cross) {
		isCross = cross;
	}
...
//	}
	...
	public String getShippingGameProp() {
		StringBuffer sb = new StringBuffer();
		sb.append(gameName).append(" —>").append(region).append(" —>").append(server);
		if(gameRace != null){
			sb.append(" —>").append(gameRace);
		}
		return sb.toString();
	}
