...
//                        orderInfoEO = orderInfoManager.selectById(dbOrderInfo.getOrderId());
        ...
        if (dbOrderInfo != null && dbOrderInfo.getRefererType() != null && (dbOrderInfo.getRefererType() == RefererType.mOrder.getCode()|| dbOrderInfo.getRefererType() == RefererType.AppOrder.getCode())) {
