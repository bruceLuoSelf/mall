 ...
 */
@Component
public class DirectPartialRefundConfig {
    /**
     * 转账URL
     */
    @Value("${fund.direct_partial_refund_outer.url}")
    private String url = "";

    @Value("${fund.direct_partial_refund_outer.sign.secret.key}")
    private String signSecretKey = "";

    /**
     * 接口名称
     */
    @Value("${fund.direct_partial_refund_outer.service}")
    private String service = "";

    /**
     * 签名方式
     */
    @Value("${fund.direct_partial_refund_outer.sign.type}")
    private String signType = "MD5";

    @Value("${fund.direct_partial_refund_outer.input.charset}")
    private String inputCharset = "gb2312";

    @Value("${fund.direct_partial_refund_outer.client.ip}")
    private String clientIP = "";

    @Value("${fund.direct_partial_refund_outer.version}")
    private String version = "1.0";

    @Value("${fund.direct_partial_refund_outer.trading.type}")
    private String tradingType = "6";

    @Value("${fund.direct_partial_refund_outer.request_ip}")
    private String requestIp = "";

    @Value("${fund.direct_partial_refund_outer.is_op}")
    private String isOp = "0";

    @Value("${fund.direct_partial_refund_outer.op_name}")
    private String opName = "";

    @Value("${fund.direct_partial_refund_outer.dep.name}")
    private String depName = "";

    @Value("${fund.direct_partial_refund_outer.create.internal.site.id}")
    private String createInterNalSiteId = "";

    @Value("${fund.direct_partial_refund_outer.notify.url}")
