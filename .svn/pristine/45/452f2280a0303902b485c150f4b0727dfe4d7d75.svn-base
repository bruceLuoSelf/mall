 ...
 */
@Component
public class Receive extends AbstractState {

	protected static final Log log = LogFactory.getLog(Receive.class);
	...
	private OrderInfoEO changeOrderState(String orderId, OrderState orderState)
        ...
        orderLogInfo.setLogType(LogType.ORDER_RECEIVER);
