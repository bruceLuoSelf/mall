...
import com.wzitech.gamegold.shrobot.job.AutoTransferJob;
...
//        autoTimeOutOrderForMachineDeliveryJob.autoTimeOutMachineDeliveryOrder();
        Boolean flag = orderLogManager.isHaveLog(Long.valueOf("41356666"));
...
//        System.out.println(t);
    ...
    @Autowired
    AutoTransferJob autoTransferJob;

    @Test
    public void testss(){
        autoTransferJob.autoTransfer();
    }
}
