...
Ext.define('MyApp.view.deliveryMoneyCountManager', {
    extend: 'Ext.panel.Panel',
    id: 'deliveryMoneyCountManager',
    closable: true,
    title: '收货交易完单流水',
    layout: "border",
    autoScroll: false,
        ...
        if (me.queryForm == null) {
            me.queryForm = Ext.widget('form', {
                ...
                items: [{
                    ...
                    fromName: 'tradeCountStartTime',
                    toName: 'tradeCountEndTime',
                    fromValue: new Date(),
                    toValue: new Date()
                }, {
                    fieldLabel: '订单号',
    ...
    getStore: function () {
        var me = this;
        if (me.store == null) {
            me.store = Ext.create('MyApp.store.DeliveryMoneyCountStore', {
                autoLoad: true,
                listeners: {
                    beforeload: function (store, operation, eOpts) {
                        ...
                        if (queryForm != null) {
                            ...
                            var params ={
                                ...
                                'startTime': values.tradeCountStartTime,
                                'endTime': values.tradeCountEndTime,
                            ...
                            Ext.Ajax.request({
                                url : './delivery/statisAmountTradeCount.action',
                                method: 'POST',
                                params: params,
                                success : function(response, opts) {
                                    var json = Ext.decode(response.responseText);
                                    ...
                                    Ext.getCmp('moneySummary1').setText("计划收购金额汇总：" +amount+"&nbsp&nbsp&nbsp  实际收购金额汇总："+realAmount+"&nbsp&nbsp&nbsp 笔数："+count+"&nbsp&nbsp&nbsp 佣金：0");
